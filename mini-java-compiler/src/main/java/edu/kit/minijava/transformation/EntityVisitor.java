...
import edu.kit.minijava.ast.nodes.ASTVisitor;
...
public class EntityVisitor extends ASTVisitor<EntityContext> {
	...
	protected void visit(ClassDeclaration classDeclaration, EntityContext context) {
		...
		currentClassName = classDeclaration.getName();
		
		StructType structType = new StructType(classDeclaration.getName());
		Entity entity = new Entity(globalType, classDeclaration.getName(), structType);
	...
	protected void visit(MainMethodDeclaration methodDeclaration, EntityContext context) {
		...
		Entity mainMethodEntity = new Entity(globalType, getUniqueMemberName(methodDeclaration.getName()), mainMethodType);
	}
	...
	protected void visit(MethodDeclaration methodDeclaration, EntityContext context) {
		...
		Entity methodEntity = new Entity(globalType, getUniqueMemberName(methodDeclaration.getName()), methodType);
